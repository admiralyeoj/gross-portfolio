          ...
          <div class="col-xs-12">
            <svg version="1.1"
              ...
              dtttt91222233Xbbbbfddtttt9122+3L2z8CDAAGA9CHeMiJOgAAAABJRU5ErkJggg==" transform="matrix(1 0 0 1 92.2048 0)">
                ...
                <ellipse id="right-eye" class="st0" cx="215.5" cy="206.9" rx="11.2" ry="16"/>
                <ellipse id="left-eye" class="st0" cx="108.7" cy="206.9" rx="11.2" ry="16"/>
                <circle class="st0" cx="42.8" cy="294.2" r="32.4"/>
                <circle class="st0" cx="283.8" cy="294.2" r="32.4"/>
                <path id="left-arm" class="st0" d="M32.8,388.4v-95.1c0-5-4-9-9-9H19c-5,0-9,4-9,9v95.1c-6,3.8-10,10.5-10,18.1
                  c0,11.8,9.6,21.4,21.4,21.4s21.4-9.6,21.4-21.4C42.8,398.8,38.8,392.2,32.8,388.4z"/>
                <path id="right-arm" class="st0" d="M316.6,388.4v-95.1c0-5-4-9-9-9h-4.8c-5,0-9,4-9,9v95.1c-6,3.8-10,10.5-10,18.1
