...
Config::define('DB_DRIVER', env('DB_DRIVER') ?: 'mysql');
...
// Limit the number of post revisions that Wordpress stores (false (default WP): store no revision)
Config::define('WP_POST_REVISIONS', env('WP_POST_REVISIONS') ?: false);
// Setting default theme
Config::define('WP_DEFAULT_THEME', 'portfolio');
